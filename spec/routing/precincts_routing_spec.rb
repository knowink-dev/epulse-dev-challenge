...
RSpec.describe PrecinctsController, type: :routing do
  describe "routing" do
    ...
    it "routes to #new" do
      expect(get: "/precincts/new").to route_to("precincts#new")
    end
    ...
    it "routes to #edit" do
      expect(get: "/precincts/1/edit").to route_to("precincts#edit", id: "1")
    end
    ...
    it "routes to #update via PATCH" do
      expect(patch: "/precincts/1").to route_to("precincts#update", id: "1")
    end
