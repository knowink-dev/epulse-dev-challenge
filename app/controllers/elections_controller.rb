class ElectionsController < ApplicationController
  before_action :set_election, only: %i[ show edit update destroy register_new_candidate ]
  ...
  private
    ...
    def election_params
      params.require(:election).permit(Election.attribute_names.map(&:to_sym), election_voters_attributes: ElectionVoter.attribute_names.map(&:to_sym), election_candidate_enrollments_attributes: ElectionCandidateEnrollment.attribute_names.map(&:to_sym))
    end
end
